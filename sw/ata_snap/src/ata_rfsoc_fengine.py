...
class AtaRfsocFengine(ata_snap_fengine.AtaSnapFengine):
    ...
    def _read_parameters_from_fpga(self):
        ...
        if self.is_8_bit:
            ...
            if self.n_chans_f < 2048:
                ...
                self.n_times_per_block = 1  # Channel reorder deals with 1 time per word
                self.n_chans_per_block = 16 # Channel reorder deals with 16 channel per word
    ...
    def select_output_channels(self, start_chan, n_chans, dests=['0.0.0.0'], n_interfaces=None, dest_ports=[10000], blank=False, nchans_per_packet_limit=None):
        """
